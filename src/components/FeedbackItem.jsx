...
function FeedbackItem({item}) {
  //************************Some basics about states and useState hook. ******************
  ...
  /* setRating() hai jaise maan lo which is a function jiss se we are changing the value of the state hook rating and 
  aese setRating mei direct value na pass kr k function pass kr k (prev) argument mei previous value of state trap ho jayegi.
  setRating((prev) => {
    console.log(prev);
    return prev+1;
  })
